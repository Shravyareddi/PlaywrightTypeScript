...
import tokenAPIRequest from '@data/api_requests/Token_API_Request.json';
import putAPIRequest from '@data/api_requests/PUT_API_Request.json';
import patchAPIRequest from '@data/api_requests/PATCH_API_Request.json';
